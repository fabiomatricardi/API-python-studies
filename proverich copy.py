...
"""
pyfiglet works like a charm in RICH
documentation at https://github.com/pwaller/pyfiglet
list of fonts here  http://www.jave.de/figlet/fonts.html
To see the result of the fonts http://www.jave.de/figlet/fonts/overview.html
http://www.figlet.org/
"""
console = Console()
...
#font2 = 'slant','banner4', 'contrast','doom','moscow','keyboard', 'ogre','oldbanner'
# 'rounded','santaclara','shadow','smkeyboard','stampatello','standard'
#'starwars', 'big','bubble', 'doom'
font2 = "smkeyboard"
print(pyfiglet.figlet_format(text= 'anime downloader', font = font2))
print(pyfiglet.figlet_format(text= 'downloader', font = font2))

# code with syntax
# ref to https://medium.com/trabe/building-rich-console-interfaces-in-python-16338cc30eaa
code = '''
