...
import datetime
"""
Using Consumenet API this software can collect information about specific KDrama Series
https://docs.consumet.org/rest-api/Movies/viewasian/search
...
"""
# Using the example query "glory" for THE GLORY series, and looking at the 2nd page of results.
url = "https://api.consumet.org/movies/viewasian/glory"
